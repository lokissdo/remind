...
from src.types.local import LocalDataSource
...
class LocalDataSourceTest(unittest.TestCase):
    ...
    def test_add_data_image_directory_with_no_existing_files(
        ...
        embedding_model_config = mock.Mock()
        embedding_model = mock.Mock()

        embedding_model_config.get_embedding_model.return_value = [embedding_model]
        ...
        self.local_data_source.add_data(
            directory, embedding_model_config, vector_database
        )
    ...
    #     # Add local datasource data for a local directory
    #     self.local_data_source.add_data(
    #         filename, embedding_model_config, vector_database
    #     )
    #     assert vector_database.add.mock_calls == [
    #         mock.call(
    #             filename,
