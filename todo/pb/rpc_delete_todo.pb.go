...
func (x *DeleteTodoRequest) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
var file_rpc_delete_todo_proto_rawDesc = []byte{
	...
	0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x3f, 0x0a, 0x11, 0x44,
	0x65, 0x6c, 0x65, 0x74, 0x65, 0x54, 0x6f, 0x64, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64,
	0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x2e, 0x0a, 0x12,
	...
	0x72, 0x65, 0x6d, 0x69, 0x6e, 0x64, 0x2f, 0x74, 0x6f, 0x64, 0x6f, 0x2f, 0x70, 0x62, 0x62, 0x06,
...
var file_rpc_delete_todo_proto_goTypes = []any{
	(*DeleteTodoRequest)(nil),  // 0: pb.DeleteTodoRequest
	(*DeleteTodoResponse)(nil), // 1: pb.DeleteTodoResponse
}
...
func file_rpc_delete_todo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rpc_delete_todo_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_rpc_delete_todo_proto_msgTypes[1].Exporter = func(v any, i int) any {
